...
public class HelloApplication extends Application {
    ...
    private static final String URL = "jdbc:mysql://localhost:3306/fxml_db";
    ...
    public void start(Stage stage) throws Exception {
        ...
        Text sceneTitle = new Text("Sign Up to CSIT228");
        ...
        lblemail.setTextFill(Paint.valueOf("#c251d5"));
        lblemail.setFont(Font.font(40));
        grid.add(lblemail, 0, 1);

        TextField tfemail = new TextField();
        tfemail.setFont(Font.font(35));
        ...
        btnSignIn.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                for (User user : users) {
                    if (username.equals(user.username) && email.equals(user.email) && password.equals(user.password)) {
